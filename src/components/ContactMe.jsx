      ...
      <section className="bg-zinc-900 w-[min(100%,_700px)] flex justify-center flex-col items-center gap-2 p-4">
        ...
        <form onSubmit={sendEmail} className="grid place-items-center gap-4 w-full">
          <div className="flex flex-col justify-center items-center w-[min(100%,_400px)]">
            ...
            <input className="text-black outline-none  p-1 px-2 w-full" type="text" id="name" name="user_name" autoComplete='off' required/>
          </div>
          <div className="flex flex-col justify-center items-center w-[min(100%,_400px)]">
            <label htmlFor="email" name="user_mail">{t("eng.mail")}</label>
            <input className="text-black outline-none p-1 px-2 w-full" type="email" id="email" name="email" autoComplete='off' required/>
          </div>
          <div className="flex flex-col justify-center items-center w-[min(100%,_400px)]">
          ...
          <div>
            <input className='bg-green-600 px-4 hover:bg-purple-600 hover:scale-105 cursor-pointer transition-all' type="submit" value={t("eng.btnSend")} />
          </div>
        </form>
      </section>
    </main>
